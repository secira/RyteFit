...
const PracticeTestsJEE = () => {
  const [, navigate] = useLocation();
  const { toast } = useToast();
  
  const examType = 'JEE';
  const serviceType = 'JEE_STANDARD';
  ...
  const handleStartPracticeTest = async (paperId?: string) => {
    ...
    if (!data || data.availableCredits <= 0) {
      toast({
        ...
        description: `You don't have any JEE practice test credits. Please purchase a practice pack to continue.`,
        variant: "destructive",
      });
      return;
    }
      ...
      <div className="min-h-screen bg-background">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-muted-foreground">Loading JEE practice tests...</p>
          </div>
        </div>
      </div>
    );
        ...
        <Card className="max-w-lg w-full">
          ...
          <CardContent className="space-y-6">
            <p className="text-center text-muted-foreground">
              JEE practice tests are only available to subscribed members. Upgrade to our JEE Standard Plan to get unlimited access to all mock tests.
            </p>
            
            <div className="p-4 bg-muted rounded-lg">
              <p className="font-semibold text-foreground mb-3">JEE Standard Plan Benefits:</p>
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Take full-length JEE Main practice tests with detailed analytics and national ranking.
              90 questions covering Mathematics, Physics, and Chemistry in 180 minutes.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto space-y-6">
          {/* Credits Status Card */}
          <Card className="border-2 border-primary/20" data-testid="credits-card-jee">
            <CardHeader>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="text-center">
                  <p className="text-2xl font-bold text-primary" data-testid="total-tests-jee">
                    {currentExamData?.totalTests || 0}
                  </p>
                  <p className="text-sm text-muted-foreground">Tests Taken</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-green-600" data-testid="average-score-jee">
                    {currentExamData?.averageScore !== null && currentExamData?.averageScore !== undefined ? `${currentExamData.averageScore}%` : 'N/A'}
                  </p>
                  <p className="text-sm text-muted-foreground">Average Score</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-blue-600" data-testid="best-score-jee">
              ...
              {hasCredits ? (
                papers.length > 0 ? (
                  ...
                  <Button 
                    ...
                    data-testid="button-start-test-jee"
                  >
                ...
                <div className="space-y-3">
                  <Button 
                    ...
                    className="w-full" 
                    disabled
                    data-testid="button-no-credits-jee"
                  >
                  ...
                  <PaymentButton
                    ...
                    className="w-full"
                    data-testid="button-purchase-jee"
                  >
          ...
          {hasCredits && papers.length > 0 && (
            <Card data-testid="production-papers-card-jee">
              <CardHeader>
                <CardTitle className="text-lg">Available JEE Mock Tests</CardTitle>
          ...
          <Card data-testid="info-card-jee">
            <CardHeader>
              <CardTitle className="text-lg">JEE Practice Test Details</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">90 questions</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
          ...
          {/* Features Card */}
          <Card data-testid="features-card-jee">
            <CardHeader>
            ...
            <CardContent>
              <ul className="space-y-2">
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <span>Subject-wise breakdown (Math, Physics, Chemistry)</span>
                </li>
                <li className="flex items-center space-x-2">
          ...
          {currentExamData && currentExamData.totalTests > 0 && (
            <Card className="hover-elevate" data-testid="history-card-jee">
              <CardContent className="pt-6">
                <Button 
                  variant="outline" 
                  className="w-full" 
                  asChild
                  data-testid="button-view-history-jee"
                >
                  <Link href="/dashboard?tab=analytics&examType=JEE">
...
export default PracticeTestsJEE;
